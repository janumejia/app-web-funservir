...
import { Row, Col, Input, Button, Select, InputNumber, Tooltip } from 'antd';
      ...
      <FormContent>
        ...
        >
          <Controller
            ...
            defaultValue={state && state.dataAddSite && state.dataAddSite.moreInfoInclusivity ? state.dataAddSite.moreInfoInclusivity : ""}
            control={control}
            rules={{
              required: false,
