...
import { Row, Col, Input, Button, Select, InputNumber, Divider, Tooltip } from 'antd';
      ...
      <FormContent>
        ...
        >
          <Controller
            ...
            defaultValue={state && state.data2 && state.data2.moreInfoInclusivity ? state.data2.moreInfoInclusivity : ""}
            control={control}
            rules={{
              required: false,
